...
def leverrier_faddeev_poly(A):
    ...
    B = np.eye(n)
    C = np.zeros_like(A)
    coeffs = [1]  # Comenzamos con el coeficiente 1 para lambda^n
...
# Obtener raíces (autovalores) y vectores propios
eigenvalues, eigenvectors = np.linalg.eig(A)

# Formatear y mostrar autovalores
...
# Formatear y mostrar autovectores
